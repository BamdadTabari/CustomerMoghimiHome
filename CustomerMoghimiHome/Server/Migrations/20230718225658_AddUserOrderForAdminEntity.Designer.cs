...
namespace CustomerMoghimiHome.Server.Migrations
{
    ...
    [Migration("20230718225658_AddUserOrderForAdminEntity")]
    partial class AddUserOrderForAdminEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CustomerMoghimiHome.Server.EntityFramework.Entities.Customer.ContactFormEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("ContactFormEntity", "dbo");
                });
            ...
            modelBuilder.Entity("CustomerMoghimiHome.Server.EntityFramework.Entities.Shop.UserBasketEntity", b =>
                {
                    ...
                    b.Property<long>("UserOrderForAdminEntityId")
                        .HasColumnType("bigint");

                    b.HasKey("Id");

                    b.HasIndex("UserOrderForAdminEntityId");

                    b.ToTable("UserBasketEntity", "dbo");
                });

            modelBuilder.Entity("CustomerMoghimiHome.Server.EntityFramework.Entities.Shop.UserOrderForAdminEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("UserOrderForAdminEntity", "dbo");
                });
            ...
            modelBuilder.Entity("CustomerMoghimiHome.Server.EntityFramework.Entities.Shop.UserBasketEntity", b =>
                {
                    b.HasOne("CustomerMoghimiHome.Server.EntityFramework.Entities.Shop.UserOrderForAdminEntity", "UserOrderForAdminEntity")
                        .WithMany("UserBasketEntities")
                        .HasForeignKey("UserOrderForAdminEntityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("UserOrderForAdminEntity");
                });
            ...
            modelBuilder.Entity("CustomerMoghimiHome.Server.EntityFramework.Entities.Shop.UserOrderForAdminEntity", b =>
                {
                    b.Navigation("UserBasketEntities");
                });
